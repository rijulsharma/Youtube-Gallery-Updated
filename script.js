...
async function loadVideos() {
  const getData = await fetch("https://dashing-daffodil-8c9e99.netlify.app/.netlify/functions/api/getall");
...
async function saveVideo(e) {
  ...
  if (videoId !== "") {
    ...
    const response = await fetch("https://dashing-daffodil-8c9e99.netlify.app/.netlify/functions/api/post", {
      method: "POST",
      mode: "cors",
      headers: {
...
async function clickVideo(event, id) {
  ...
  if (event.target.classList.contains("delete-btn")) {
    ...
    await fetch("https://dashing-daffodil-8c9e99.netlify.app/.netlify/functions/api/delete", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
